            ...
            {data.map((item, index) => (
                <TouchableOpacity
                    ...
                    style={[
                        style.mainChipWrap,
                        {
                            backgroundColor: index === selectedCategory ? theme.colors.primary : theme.colors.white,
...
function Chip({ setSelectedIdCategory, data, selectedCategory, keyExtractor, readOnly }) {
    const colorReadOnly = readOnly ? theme.colors.lightPrimary : theme.colors.white;
                ...
                return (
                    <TouchableOpacity
                        style={[
                            ...
                            {
                                backgroundColor: index === selectedCategory ? theme.colors.primary : colorReadOnly,
                            },
                        ]}
                        onPress={() => setSelectedIdCategory(index)}
                    >
