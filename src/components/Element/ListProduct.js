...
function ListProduct({ data, isFavorite, cancelButtonLabel, submitButtonLabel, bottom = 80 }) {
    ...
    return (
        <FlatList
            ...
            ListFooterComponent={<View style={[style.listFooterComponent, { height: bottom }]} />}
                    ...
                    <View style={style.main} key={index}>
                        ...
                        >
                            <ImageBackground
                                ...
                                resizeMode="center"
                            >
                                <Image source={{ uri: item.imgLink }} resizeMode="cover" style={style.image} />
                            </ImageBackground>
                        ...
                        <View style={style.btnIsFavorite}>
                            <MyButton sx={{ marginTop: 10, flex: 1 }} small color="error" title={cancelButtonLabel} />
