...
function Index() {
    ...
    const RootDashboard = () => {
        return (
            <RootDashboardNavigationStack.Navigator screenOptions={{ headerShown: false }}>
                <RootDashboardNavigationStack.Screen name="Dashboard" component={DashboardRouteStack} />
    ...
    return (
        <>
            <RootNavigationStack.Navigator screenOptions={{ headerShown: false }}>
                {auth.isAuth ? (
                    <RootNavigationStack.Screen name="RootDashboard" component={RootDashboard} />
                ) : (
                    <RootNavigationStack.Screen name="AuthRouteStack" component={AuthRouteStack} />
                )}
